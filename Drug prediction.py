...
#inplace true, it modifies the data and doesnt return anything--> df.an_operation(inplace=True)
#inplace false , it return the copy of the modified thing--> df = df.an_operation(inplace=False) 
...
# Distribution graphs (histogram/bar graph) of column data visualisation of over dataset
...
# # To build the precision of the model,we utilized three distinctive algorithm
# decision
# random forest
# knn
# naive bayes
...
w2 = Label(root, justify=LEFT, text="Contributors: Abhinav,Anuj,Vinay", fg="Pink", bg="Ivory")
w2.config(font=("Times",30,"bold italic"))
